...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements com.NdfdXML {
 ...
 */
    ...
    public com.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.NdfdXMLBindingStub _stub = new com.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.NdfdXMLBindingStub _stub = new com.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
